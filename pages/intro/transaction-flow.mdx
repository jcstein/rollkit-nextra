...
<Callout type="error" emoji="️🚫">
  DEMO: This is a dangerous feature that can cause everything to explode.
</Callout>
 
<Callout type="warning" emoji="⚠️">
  DEMO: This API will be deprecated soon.
</Callout>

<Callout emoji="👾">
  DEMO:  **Space Invaders** is a 1978 shoot 'em up arcade game developed by Tomohiro
  Nishikado.
</Callout>
