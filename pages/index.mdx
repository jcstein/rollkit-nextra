...
<div style={{ textAlign: "center" }}>
  <div className="cta-container">
    ...
    <Link className="cta" href="https://www.github.com/rollkit/rollkit">
      Github
    </Link>
  </div>
  {/* <div style={{ marginTop: "2rem" }} /> */}
  {/* <Link
    href="https://github.com/rollkit/rollkit/blob/main/LICENSE"
    target="_blank"
    style={{
  ...
  >
    Rollkit is currently licensed under APACHE-2.0 →
  </Link> */}
</div>
